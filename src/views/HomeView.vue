  ...
  <div class="conteudo">
    <div class="container-principal color-theme">
      ...
      <div
        ...
        <div class="flex flex-col lg:mt-14 md:mt-20 mt-24">
        ...
        <div class="flex text-2xl">
          <div class="">
            <img class="border-img lg:w-96 md:w-80 w-64 rounded-full" src="https://avatars.githubusercontent.com/u/82292364" />
          </div>
        </div>
      </div>
    </div>
